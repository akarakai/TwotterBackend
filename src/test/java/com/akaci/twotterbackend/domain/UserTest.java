...
class UserTest {
    ...
    private static final User USER = new User(UUID.randomUUID(), "username98", null, new HashSet<>(), new HashSet<>(), new HashSet<>());
    private static final User USER2 = new User(UUID.randomUUID(), "username89", null, new HashSet<>(), new HashSet<>(), new HashSet<>());

    @BeforeEach
    void setUp() {
        Set<User> FOLLOWED = new HashSet<>();
        FOLLOWED.add(new User(UUID.randomUUID(), "username99332", null, new HashSet<>(), new HashSet<>(), new HashSet<>()));
        FOLLOWED.add(new User(UUID.randomUUID(), "username98244", null, new HashSet<>(), new HashSet<>(), new HashSet<>()));
        FOLLOWED.add(new User(UUID.randomUUID(), "username97344", null, new HashSet<>(), new HashSet<>(), new HashSet<>()));
        FOLLOWED.add(new User(UUID.randomUUID(), "username96771", null, new HashSet<>(), new HashSet<>(), new HashSet<>()));
